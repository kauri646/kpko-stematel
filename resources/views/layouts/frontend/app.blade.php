        ...
        <header class="mb-5">
          <div class="header-top">
            <div class="container">
              <div class="logo">
                <a href="#"
                  ><img src="https://smktelkom-pwt.sch.id/wp-content/uploads/2018/10/Logo-SMK-Telkom-Purwokerto.png" alt="Logo" style="height: 40px"
                /></a>
              </div>
          ...
          <div class="container">
            <div class="footer clearfix mb-0 text-muted">
              <div class="float-start">
                <p>2023 &copy; {{ $app_name }}</p>
              </div>
              <div class="float-end">
                <p>Crafted with <span class="text-danger"><i class="bi bi-heart-fill icon-mid"></i></span>
                 by <a href="#">Adit & Kautsar</a></p>
              </div>
            </div>
          </div>
        </footer>
